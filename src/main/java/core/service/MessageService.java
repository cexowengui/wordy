...
public interface MessageService {
	 ...
	 * 1+123456+234567    表示123456这个用户需要添加234567这个用户为好友
	 ...
	 * 就不会出现歧义的数据包，举例如下：
	 * 接收到消息：
	 * 1+123456+234+567 直接判定为非法，抛弃，因为1表示添加好友，后面只会跟两个用户号码，但是并不存在234+567这样的用户号
	 * 5+123456+234567+1234+2345等于多少  直接解析为用户123456向用户234567发送的消息是1234+2345，最后一个加号不考虑为间隔符，从前往后解析
	 */
	public void messageParse(String message);//解析消息
